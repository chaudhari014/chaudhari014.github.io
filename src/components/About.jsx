...
const About = () => {
  ...
  <Fade top duration={1000} distance="40px">
    ...
    Hello! My name is Rahul Chaudhari and I enjoy creating things that live on the internet.
        </p>
        </Fade>
        <br />
        <Fade top duration={1000} distance="40px">
        <p className="text-xl">
       I'm a passionate Developer with strong administrative and communication skills, good attention to detail and the ability to write efficient code.<br />  <br />
